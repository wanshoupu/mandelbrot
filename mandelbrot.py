...
from constructs.calc import data_gen, cache_cleanup
...
def interactive_plot():
    ...
    history_handle = HistoryCtrl(plot)
    zoom_handler = MandelbrotCtrl(plot, zoom_factor=.6, history_handle=history_handle, regen=False)
